...
public class Tournament implements TaskListener {
	...
	private TournamentListener lis;
	...
	public void onFinishingFirstTask(ArrayList<Champion> winners)
		...
		if (!winners.isEmpty()) {
			...
			lis.onFinishingFirst("kamal");
		}
		else{
			lis.onFinishingFirst("bs");
		}
	}
	...
	public void onFinishingSecondTask(ArrayList<Champion> winners)
		...
		if (!winners.isEmpty()) {
			...
			lis.onFinishingSecond("kamal");
		}
		else{
			lis.onFinishingSecond("bs");
		}
	}

	public void onFinishingThirdTask(Champion winner) {

		lis.onFinishingThird();

	}

	public static ArrayList<Spell> loadSpells2(String filePath) throws IOException {
	...
	public TournamentListener getLis() {
		return lis;
	}

	public void setLis(TournamentListener lis) {
		this.lis = lis;
	}
